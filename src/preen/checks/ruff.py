            ...
            issues.append(
                Issue(
                    ...
                    description=(
                        ...
                        f"({lint_result.stdout.count(chr(10))} problems)"
                    ),
                    impact=Impact.IMPORTANT,
                    explanation=(
                        "Linting issues can indicate potential bugs, code style "
                        "problems, or maintainability concerns. While not "
                        "blocking, they should be addressed for code quality."
                    ),
        ...
        if format_result.returncode != 0:
            ...
            issues.append(
                Issue(
                    ...
                    impact=Impact.IMPORTANT,
                    explanation=(
                        "Consistent code formatting improves readability and "
                        "reduces diff noise in version control. Consider "
                        "fixing before release."
                    ),
                    override_question=(
                        "Continue with release despite formatting issues?"
                    ),
                    proposed_fix=Fix(
